    ...
    <>
      <StyledNavContainerActive>
        <AnimatePresence>
          ...
          >
            <a href="#home" onClick={() => setNav(true)}>
              <img src={whale4} alt="Node Whales" />
            </a>
          </StyledNavLogo>
          <StyledBurgerContainer
            key={"StyledBurgerContainer"}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            {nav ? (
              <MenuIcon onClick={() => setNav(false)}></MenuIcon>
            ) : (
              <MenuOpenIcon onClick={() => setNav(true)}></MenuOpenIcon>
            )}
          </StyledBurgerContainer>
        </AnimatePresence>
      </StyledNavContainerActive>
      <AnimatePresence>
        {!nav && (
          <div key={"StyledDropDownContainer"}>
            <StyledNavDropDown
              key={"child"}
              onClick={() => setNav(true)}
              ...
              exit={{ opacity: 0 }}
            >
              <StyledAbout key={"child1"}>
                <a href="#about" onClick={() => setNav(false)}>
                  <h1>About</h1>
                </a>
              </StyledAbout>
              <StyledTokenomics key={"child2"}>
                <a href="#tokenomics" onClick={() => setNav(false)}>
                  <h1>Tokenomics</h1>
                </a>
              </StyledTokenomics>
              <StyledRarity key={"child3"}>
                <a href="#rarity" onClick={() => setNav(false)}>
                  <h1>Tiers</h1>
                </a>
              </StyledRarity>
              <StyledDashboard>
                <a
                  href="http://dashboard.yieldwhales.com"
                  target="_blank"
              ...
              <StyledMint key={"child11"}>
                <a
                  href="http://mint.yieldwhales.com/"
                  target="_blank"
                  onClick={() => setNav(false)}
                >
                  <h1>Mint</h1>
              ...
              <StyledTwitter key={"child4"}>
                <a
                  href="https://twitter.com/NodeWhales"
                  target="_blank"
                  onClick={() => setNav(false)}
                >
                  <svg
              ...
              <StyledDiscord key={"child5"}>
                <a
                  href="https://discord.com/invite/ewAVNRpX9w"
                  target="_blank"
                  onClick={() => setNav(false)}
                >
                  <svg
            ...
            <StyledBg onClick={() => setNav(true)}></StyledBg>
          </div>
        )}
      </AnimatePresence>
    </>
...
const StyledBurgerContainer = styled(motion.div)`
  grid-row: 1/2;
  grid-column: 2/3;
  align-self: center;
  justify-self: end;
...
const StyledNavDropDown = styled(motion.div)`
  position: fixed;
  width: 100vw;
  height: 40vh;
  left: 0;
...
`;
const StyledTokenomics = styled(motion.div)`
  grid-row: 2/3;
  grid-column: 1/5;
  align-self: center;
  justify-self: center;
...
`;
const StyledRarity = styled(motion.div)`
  grid-row: 3/4;
  grid-column: 1/5;
  align-self: center;
  justify-self: center;
